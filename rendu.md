...
L'alimentation des différentes dimensions se fait en utilisant les données de l'Insee pour les critères socio-économiques, et les données du Ministère de l'Intérieur pour les votes et les candidats.
